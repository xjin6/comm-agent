...
| [skill-causal-inference](./general-skill/skill-causal-inference/) | v0.2.0 | Diagnose and run DID, PSM, PSW, IV, RDD causal inference methods with three-line Word tables and diagnostic plots |
